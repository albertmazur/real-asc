            ...
            <form action="{{route("event.dashboard")}}" method="get">
                ...
                <div class="mb-3">
                    ...
                    <select name="sortSearch" class="form-select" aria-label="Default select example">
                        ...
                        <option @if ($sortSearch=="price") selected @endif value="price">Cena</option>
                    </select>
                </div>
                    ...
                    <tbody>
                        @foreach ($events as $event)
                            <tr>
                                ...
                                <td>{{ $event->freeSet}}</td>
                                <td>{{ $event->price}}</td>
                                <td><a class="btn btn-info" role="button" href="{{ route("event.edit", ["eventId" =>$event->id])}}">Edytuj</a></td>
